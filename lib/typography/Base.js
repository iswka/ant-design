...
var Base = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(Base, [{
    ...
    value: function renderContent() {
      ...
      var prefixCls = this.getPrefixCls();
      var textProps = (0, _omit["default"])(restProps, ['prefixCls', 'editable', 'copyable', 'ellipsis', 'mark', 'code', 'delete', 'underline', 'strong', 'keyboard', 'italic', 'small'].concat((0, _toConsumableArray2["default"])(_configProvider.configConsumerProps)));
